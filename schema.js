...
export const shipmentStatusEnum = pgEnum('shipment_status', ['PENDING', 'ASSIGNED', 'PICKED_UP', 'DELIVERED']);
...
export const shipments = pgTable('shipments', {
  ...
  packageDimensions: varchar('package_dimensions', { length: 100 }), // e.g., "30x20x15"
